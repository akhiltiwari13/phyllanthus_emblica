/**
 * This program has not been tested thoroughly because generating test case for
 * this problem seems like a lot of hassle.!
 **/
...
void parser(const std::string pkt) {
  ...
  while ((start_idx != std::string::npos) && (start_idx < 65536) &&
    ...
    /* std::cout<<"[DEBUG] pkt.at(start_idx + 9)="<<pkt.at(start_idx +
     * 9)<<std::endl; */
