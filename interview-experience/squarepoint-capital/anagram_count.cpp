...
void solve(const string& word, unordered_map<string, long>& anagramCache,
           vector<pair<string, long>>& wordcount) {
...
int main(int argc, char* argv[]) {
  ...
  vector<pair<string, long>>
      wordcount; /* for sorting the map based on the value, use a vector<pair<>>
                    instead. */
