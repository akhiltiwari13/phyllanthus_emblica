 ...
 * @brief  The ask was for each string str in queries, find the length of
 * (lexicographically) first substring in the given string s. Return the sum of
 * lenghts for all string str in queries.
 * @version 0.1
 * @date 2023-02-06
 *
