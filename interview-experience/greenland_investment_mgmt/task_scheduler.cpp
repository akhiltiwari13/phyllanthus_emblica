...
void printHelp() {
  ...
  std::cout << "This program calculates the minimum number of machines needed "
  ...
  std::cout << "  Next line: Number of tasks (should be same as n)"
            << std::endl;
