...
//        int count_ones = 0;
//        for (const auto& [right, ch] : input_str.substr(left) |
//        std::views::enumerate) {
//            count_ones += (ch == '1');
//            if (count_ones == k) {
//                const auto current_length = right + 1;
//                auto current_substring = input_str.substr(left,
//                current_length);
//
//                if (current_length < min_length ||
//                    (current_length == min_length && current_substring <
//                    result)) { min_length = current_length; result =
//                    current_substring;
//                }
//                break;  // No need to check longer substrings starting from
//                'left'
//            }
//        }
//    }
