...
<img align="right" width="100" height="100" src="logo/logo.ico">

## **Description**:  This project is a collection of my solutions to interview problems that I have encountered. If a problem ends up here, it should imply: I could not get it done when I was supposed to. :sweat_smile:

- ## [Goldman Sachs](https://www.goldmansachs.com/) 
    > The problem was to find the root node of the largest tree (with the larges number of nodes) in a forest. More info about the problem can be found below.

    1. [gs1](img/goldman_sachs/cpad_1/gs_largestForest0.png)
    2. [gs2](img/goldman_sachs/cpad_1/gs_largestForest1.png)
    2. [gs3](img/goldman_sachs/cpad_1/gs_largestForest2.png)

    [Solution](GS/largestTreeinForest.cpp) 
    

- ## [jumpTrading](https://www.jumptrading.com/) The problem was to implement a file iterator that parses numerical data. More info about the problem can be found below.
