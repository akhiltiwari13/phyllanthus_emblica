...
int main() {
  ...
  json temp = {{"integer", 42},           {"floating", 3.14},
               {"string", "hello world"}, {"boolean", true},
  ...
  std::cout << first << is_int << is_float << is_string << is_boolean
            << is_array << is_object << std::endl;
